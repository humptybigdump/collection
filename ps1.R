...
# assumed to be in the directory C:\Users\schienle\Desktop\Melanie\Finetrics. 
...
mydir<- "C:/KIT-Projekte/R-Projects" #Insert the Directory (i.e. folder) of the file here

#alternatively, you can copy the file to your current directory
getwd() #shows current working directory
#Then, you can skip the setwd part
...
#
## look at data and how to manipulate it
#
...
# alternatively
sbux.ccret.1 = log(sbuxPrices.df[2:n,1]) - log(sbuxPrices.df[1:(n-1),1])
...
MSFTSP500.prices = merge(MSFT.prices, SP500.prices) #or use cbind here
...
hist(MSFT.ret.mat,main="Histogram of MSFT monthly returns",
...
jarque.bera.test(MSFT.ret.mat) #non normal
jarque.bera.test(SP500.ret.mat) #non normal
jarque.bera.test(gwn) #normal
