...
#####################
"""
Module enthalten Funktionen, die nach dem Import ausgeführt werden können.
Syntax: modul.funktion(Argumente)
...
# Module importieren funktioniert über import modulName
import os
os.getcwd()
...
os.chdir('/home/hendrik/edu/KIT/oekologische_klimafolgen/ws_20_21/python/') 

# Variablen definieren - Alles nach einem #-Zeichen ist ein Kommentar
x = 11 # Ganze Zahlen: integer
y=22.21  # Kommazahl: float; Leerstellen sind egal
f = "hello" # Zeichen zwischen "" oder '' nennt man strings
...
Arrays enthalten immer nur einen Datentyp 
...
bikers = df['total'].resample('d').sum()[avg_t_seattle.time[0]:avg_t_seattle.time[-1]]
