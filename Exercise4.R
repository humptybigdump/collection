#Financial Econometrics II Problem Set 4

###################################
#Problem 7: Estimation Techniques for Stochastic Volatility Models
...
#parameters are very similar, difference is that we
