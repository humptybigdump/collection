...
%Stellsignal
%nach 2 Sekunden lauten die gewünschten Ausgangswerte [2;0] und nach 5
%Sekunden [2;-1]
%Die zugehörigen Stellwerte können über inv(dcgain(sys))*([2;0] bzw. [2;-1]) berechnet
...
%Entwurf LQ-Regler
t=[0:0.01:10]'; %jetzt kürzer, da Regler das Einschwingen beschleunigt
%Sollsignal
