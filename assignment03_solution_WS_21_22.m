...
lgd = legend('Measured Points', 'Least Squares');
lgd.FontSize = 16;
...
delete(huber_plot);
lgd = legend('Measured Points','Least Squares','Random Points','M-Estimator + Huber');
lgd.FontSize = 16;
pause(duration);
...
delete(cauchy_plot);
lgd = legend('Measured Points','Least Squares','Random Points','M-Estimator + Huber','M-Estimator + Cauchy');
lgd.FontSize = 16;
pause(duration);
...
lgd = legend('Measured Points','Least Squares','Random Points','M-Estimator + Huber','M-Estimator + Cauchy','RANSAC');
lgd.FontSize = 16;
pause(duration);
