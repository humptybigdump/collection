...
sourceDirectories = { ...
	'../Hoechst_nACGFP_FabS5PCy3_Inhibitors_11August2021/Ctrl/',...
	'../Hoechst_nACGFP_FabS5PCy3_Inhibitors_11August2021/Lat/',...
    '../Hoechst_nACGFP_FabS5PCy3_Inhibitors_11August2021/Swin/',...
    '../Hoechst_nACGFP_FabS5PCy3_Inhibitors_11August2021/Trip/',...
    '../Hoechst_nACGFP_FabS5PCy3_Inhibitors_11August2021/Flav/',...
	};
extractTargetFolder = 'ExtractedStacks';
condInds = (1:5)';
condLabels = {...
	'Ctrl','Lat','Swin','Trip','Flav'
	};
maxNumSeries = Inf;
...
useChannel_inds = [3,4,1]; % DNA, Pol II Ser5P, Nuclear Actin
