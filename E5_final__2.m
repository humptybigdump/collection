...
%% Exercise 5: Water movement in unsaturated soils
...
% at start, system is out of equilibrium/stationary state. With constant
% water supply, system will reach equilibrium/stationary state after a
% certain time.
for i = 2:dim-1
    theta(i) = theta(i) - dt * ((q(i-1)-q(i)) / abs(dz(1))); % continuity equation to calculate change of soil moisture in each soil layer
end

% Hint: the combination of darcy-buckingham equation (line 55) and
% continuity equation (line 65) is also called "Richards equation"
