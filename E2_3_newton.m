...
% x=[0.3 0.4 0.5 0.6 0.1 0.2 0.8 0.9 1 0.7];
...
x=[0:0.1:1];
% try different order of data points
%x=[0.3 0.4 0.5 0.6 0.1 0.2 0.8 0.9 1 0.7 0];
...
% i.e. fill in first column of Newton's divided difference table
for i=1:k
    fd(i,1)=y(i);
end
...
%------------
% show result
disp('n, yinterp, true error, approximation error =')
[[0:k-1]' yinterp' true_error' approx_error']

figure
subplot(1,2,1)
line([1 k]-1,[f(xinterp) f(xinterp)],'color','r','linewidth',2); %true solution
hold on
