...
spplot(spAggr) # plots all components on same colour scale
...
# Implement this as an exercise using the functions from the Geomet script:
...
# Now you can implement the same calculations as above for the individual simulations in 
# for loops. Have a go at this! 
