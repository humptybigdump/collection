...
# Datenimport
personen <- fread("//ifv-fs.ifv.kit.edu/Lehre/Lehrveranstaltungen/Empirische Daten im Verkehrswesen/WS21-22/Übung/MOP_Daten/P.csv", header=T)
wege <- fread("//ifv-fs.ifv.kit.edu/Lehre/Lehrveranstaltungen/Empirische Daten im Verkehrswesen/WS21-22/Übung/MOP_Daten/Wege.csv", header=T )
