%% Design of flood-defence reservoir Water and Energy Cycles WS 22/23
...
% and alpha
MC_N = 100000; % total number of Monte Carlo runs

% random value ranges for parameters A_out and alpha
A_out_range = 0.01 + (5.00-0.01) * rand(MC_N,1);
alpha_range = 0.002 + (0.2-0.002) * rand(MC_N,1);
