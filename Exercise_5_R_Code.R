...
directory <- paste0(getwd(), "/eps71.txt")
labor_data <- read.table(directory, header = TRUE)
...
# new_X is assumed to be ordered (as in KernSmooth)
...
plot(labor_data$age, labor_data$logwage, ylab = "Y: Log-Einkommen", xlab = "X: Alter")
lines(lcr_opt$x, lcr_opt$y, lwd = 1, col = "black")
lines(llr_opt$x, llr_opt$y, lwd = 1, col="red")
# lines(lpr2_opt$x, lpr2_opt$y, lwd = 1, col = "blue")
# lines(lpr3_opt$x, lpr3_opt$y, lwd = 1, col = "green")
lines(lpr4_opt$x, lpr4_opt$y, lwd = 1, col = "violet")
lines(lpr5_opt$x, lpr5_opt$y, lwd = 1, col = "orange")
