#Financial Econometrics II Problem Set 2

#Problem 4: GARCH models in R
...
models_garch[order(models_garch[,4]),] #punishes larger models more (depending on sampel size)
...
egarch_insamp_large<-ugarchfit(spec_oos_egarch,eur.ret.vec,out.sample = 10)
boot_simple_egarch<-ugarchboot(egarch_insamp_large,method="Partial",n.ahead = 10,
