%% Conceptual modelling using a HBV model on annual scale and Monte-Carlo calibration, Part 2. Water and Energy Cycles WS 22/23
...
% assumption of 3 mm each day (cf. exercise 6).
