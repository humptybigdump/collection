...
personen <- fread("C:/Desktop/EDIV_Übung/MOP/P.csv")

#1.2
#neue Variable in neuer Spalte
personen[, alter := 2022-GebJahr]

#1.3
#Daten l�schen mit Subset & Spalten-Name
...
save(ohne_info, file = "C:/Desktop/EDIV_Übung/data_erg.RData")
