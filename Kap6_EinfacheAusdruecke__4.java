    ...
    public static void main (String [] args){
	  ...
	  // Einstellig:
       ...
       int c = a++; // s.6.3
        ...
        // Zweistellig:
       double d = a + b; // + steht für Addition, ergibt d = 0        
       double e = a - b; // - steht für Subtraktion, ergibt e = 2
       double f = a * b; // ergibt f = -1
        ...
        double d = 5/3; 
        System.out.println ("5/3 = " + d); //Integerdiv.: Kann zu ungewollten Ergebnissen führen
        double e = 5/3.; 
        ...
        //Inkrement- und Drekementoperationen
        int j = 22;
        ++j;    //enstspricht j = j + 1;
        System.out.println ("Für j = 22 ergibt ++j: j = " + j);
        int k = 33;
        k++;    //enstspricht k = k + 1;
        System.out.println ("Für k = 33 ergibt k++: k = " + k);
        ...
        System.out.println ("180° enspricht im Bogenmaß " + o);
