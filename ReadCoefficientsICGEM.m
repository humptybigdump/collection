function [Cnm,Snm,sCnm,sSnm,GM,R,nmax] = ReadCoefficientsICGEM(filename)
% function [Cnm,Snm,sCnm,sSnm,GM,R,nmax,time_period_mid,time_period_start,time_period_stop] = ReadCoefficientsICGEM(filename)
