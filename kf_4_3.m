...
uncertainty_measure_motion = 0.1;
R = [uncertainty_measurement_position*uncertainty_measurement_position 0 0 0 ;
     0 uncertainty_measurement_position*uncertainty_measurement_position 0 0 ;
     0 0 uncertainty_measure_motion*uncertainty_measure_motion 0 ;
     0 0 0 uncertainty_measure_motion*uncertainty_measure_motion ];
...
for i = 1:numT
    ...
    %z = measurement(i,:)';
    z = [measurements(i,:) delta_motion(i,:)]';
