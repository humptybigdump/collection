...
initial_state_uncertainty = 1000000
...
uncertainty_prediction_postion = 0.01; %0.00005; % 0.01;
uncertainty_prediction_velocity = 0.01; %0.00005; % 0.01;
...
uncertainty_measurement_velocity = 0.1;
R1 = uncertainty_measurement_position * uncertainty_measurement_position * eye(dims/2);
R2 = uncertainty_measurement_velocity * uncertainty_measurement_velocity * eye(dims/2);
R = [R1, zeros(dims/2); zeros(dims/2), R2]
