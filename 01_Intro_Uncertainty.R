...
data["age"] # extract column “age” from object "data"
data$age # extract column "age" from data.frame "data"; or object "age" from a list, if "data" is a list
...
log(summary(Age_Simulation[[21]])$coefficients[2,1]+1)*48.8e9/log(2) # -> Median ages highly variable! 
...
# Technically, the compound error of two independent errors a and b is √(a^2 + b^2)
