...
for n=1:2:15
    ...
    legend('true solution','known data points', 'approximated function')
    drawnow
    pause(0.5)
...
plot(xinterp,ysp,'-g','linewidth',3)

legend('true solution','known data points', 'approximated function','spline')
