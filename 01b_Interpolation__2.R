...
wind.compo = wind.compo[,-c(1,4,5)] # Introduce new variable: Remove Mn, P and S
...
wind.alr.vgAnis2 = variogram(wind.alr.gg, cutoff=50, width=3.5, alpha=c(90,180), tol.hor=45)
...
md0 = vgm("Exp") # Define variogram template to be fitted ("Sph" - spherical, "Exp" - Exponential, "Gau" - Gaussian)
...
mdA = vgm(psill=1, model="Exp", range=15, nugget=1, anis=c(90,0.7))
